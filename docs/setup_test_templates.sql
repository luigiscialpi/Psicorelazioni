...
-- Gli utenti possono eliminare solo i template NON predefiniti (built_in = false)
CREATE POLICY "Utenti autenticati possono eliminare test_templates custom" 
ON test_templates FOR DELETE 
TO authenticated 
USING (built_in = false);
